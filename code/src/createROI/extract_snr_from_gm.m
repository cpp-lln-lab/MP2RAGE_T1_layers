...
%% find WM, GM and WMandGM
    ...
    outputNameSNRstatsUNIT1GM = ['sub-' subLabel ...
                               '_ses-001_acq-r0p75_hemi-L_desc-SNRStatsROIsGM_UNIT1.tsv';...
                               'sub-' subLabel ...
                               '_ses-001_acq-r0p75_hemi-R_desc-SNRStatsROIsGM_UNIT1.tsv'];
    outputNameSNRstatsT1mapGM = ['sub-' subLabel ...
                               '_ses-001_acq-r0p75_hemi-L_desc-SNRStatsROIsGM_T1map.tsv'; ...
                               'sub-' subLabel ...
                               '_ses-001_acq-r0p75_hemi-R_desc-SNRStatsROIsGM_T1map.tsv'];
                          
    fileNameSNRstatsUNIT1_L = fullfile(opt.dir.output, ['sub-' subLabel], 'ses-001', 'anat', outputNameSNRstatsUNIT1GM(1,:));
    fileNameSNRstatsUNIT1_R = fullfile(opt.dir.output, ['sub-' subLabel], 'ses-001', 'anat', outputNameSNRstatsUNIT1GM(2,:));
    
    fileNameSNRstatsT1map_L = fullfile(opt.dir.output, ['sub-' subLabel], 'ses-001', 'anat', outputNameSNRstatsT1mapGM(1,:));
    fileNameSNRstatsT1map_R = fullfile(opt.dir.output, ['sub-' subLabel], 'ses-001', 'anat', outputNameSNRstatsT1mapGM(2,:));
